...
<template>
  <div>
    ...
    <nav-bread>
      <span slot="homeChild">Address</span>
    </nav-bread>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkAddressIndex==index}" @click="checkAddressIndex=index;selectedAddrId=item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-set-default">
                    <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" @click="setDefault(item.addressId)"><i>Set Default Address</i></a>
                  </div>
          ...
          <div class="shipping-method-wrap">
            <div class="shipping-method">
              <ul>
                <li v-bind:class="{'check':checkMethodIndex==0}" @click="checkMethodIndex=0">
                ...
                <li v-bind:class="{'check':checkMethodIndex==1}" @click="checkMethodIndex=1">
                  <div class="name">Fast Shipping</div>
                  <div class="price">￥15</div>
                  <div class="shipping-tips">
                    <p>Once shipped，Order should arrive in the destination in 1-3 business days</p>
                  </div>
                </li>
              </ul>
            </div>
