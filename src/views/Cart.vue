<template>
  <div>
    ...
    <nav-bread>
      <span slot="homeChild">{{breadTitle}}</span>
    </nav-bread>
    ...
    <div class="container">
      <div class="cart">
        <div class="page-title-normal">
          <h2 class="page-title-h2"><span>{{title}}</span></h2>
        </div>
        ...
        methods:{
          ...
          editCart(flag,item){
            ...
            axios.post("/users/cartEdit",{
              ...
              let res = response.data;
              if(res.status=="0"){
                if(item.checked=='1' && (flag=="add" || flag=="minu")){
//                  如果是对选中项进行加减
            ...
            axios.post("/users/editCheckAll",{
              ...
              if(res.status=='0'){
                axios.get("users/getCartCount").then(response=>{
                  ...
                  console.log("update suc"+"CartCount="+res.result);
                });
              }
            })
          },
