    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <span class="navbar-link" v-text="'User : '+nickName" v-if="nickName"></span>
          <a href="javascript:void(0)" class="navbar-link" v-if="!nickName" @click="loginModalFlag=true">Login</a>
          <a href="javascript:void(0)" class="navbar-link">/</a>
          <a href="javascript:void(0)" class="navbar-link" v-if="!nickName" @click="register">Register</a>
          <a href="/" class="navbar-link" v-if="nickName" @click="logout">Logout</a>
          <div class="navbar-cart-container">
            <span class="navbar-cart-count" v-if="cartCount">{{cartCount}}</span>
            <a class="navbar-link navbar-cart-link" @click="goCart">
              <svg class="navbar-cart-logo">
                <use xmlns:xlink="@asse" xlink:href="#icon-cart"></use>
              </svg>
            </a>
          </div>
        </div>
...
<script>
  ...
  import {mapState} from 'vuex'
    export default{
        ...
        computed:{
//            mapState 封装了State，返回了一个Objdect
//          ...为对象拆解
